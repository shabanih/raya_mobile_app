...
String getChargeTitle(Map<String, dynamic> charge) {
final title = charge['title']?.toString().trim();

if (title != null && title.isNotEmpty) {
return toPersianDigits(title);
}

final type = charge['charge_type']?.toString();
...
case 'fix_area':
result = 'شارژ ثابت + متراژ';
break;

case 'person_area':
result = 'شارژ نفری + متراژ';
break;

case 'fix_person_area':
result = 'شارژ ثابت + نفری + متراژ';
break;
...
//
// is_paid = true
// یعنی مدیر ساختمان پرداخت را تأیید کرده است.
//
// is_paid = false
// یعنی هنوز تأیید نشده است.
//
// payment_pending = true
// یعنی کاربر درخواست پرداخت ثبت کرده
// و منتظر تأیید مدیر است.
// =====================================================
