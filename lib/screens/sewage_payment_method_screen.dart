...
class SewagePaymentMethodScreen extends StatefulWidget {
  final int installmentId;

  const SewagePaymentMethodScreen({
    super.key,
    required this.installmentId,
  });

  @override
  State<SewagePaymentMethodScreen> createState() =>
      _SewagePaymentMethodScreenState();
}

class _SewagePaymentMethodScreenState
    extends State<SewagePaymentMethodScreen> {
  ...
  Future<void> _submitPayment() async {
    ...
    try {
      ...
      final result =
      await _apiService.submitManualSewageInstallmentPayment(
  ...
  Widget _buildInstallmentCard() {
    ...
    final sewageName =
        installment['sewage_name']?.toString() ??
            ' هزینه فاضلاب';
