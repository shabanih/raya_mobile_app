...
class ManualCivilPaymentScreen extends StatefulWidget {
  final int installmentId;

  const ManualCivilPaymentScreen({
    super.key,
    required this.installmentId,
  });

  @override
  State<ManualCivilPaymentScreen> createState() =>
      _ManualCivilPaymentScreenState();
}

class _ManualCivilPaymentScreenState
    extends State<ManualCivilPaymentScreen> {
